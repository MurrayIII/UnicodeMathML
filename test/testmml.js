...
const speechExpect1 = ['1', 'end of numerator', '2', 'pi ',
    'end of denominator', 'integral with limits', 'integral ', 'end of base', '0',
    'end of lower limit', '2', 'pi ', 'end of upper limit', 'int-agrand fraction',
    'differential d ', 'theta ', 'end of numerator', 'eigh ', '+', 'b ',
    'sine', 's', 'i', 'n', 'function apply ', 'theta ',
    'end of function', 'end of denominator', 'end of fraction', '=',
...
const rightArrowExpect5 = ['Ⓐ()∫_−∞^∞ 𝑒^−𝑥² ⅆ𝑥=√𝜋', 'Ⓐ(1)∫_−∞^∞ 𝑒^−𝑥² ⅆ𝑥=√𝜋',
...
const speechExpect5 = ['integral ', 'end of base', 'minus ',
...
const uMath6 = '1/8𝜋² ∫_𝛼₁^𝛼₂ ⅆ𝛼′₂[𝑈_𝛿₁𝜌₁^2𝛽-2𝑎′]'
const homeExpect6 = 'Ⓐ() 1/8𝜋² ∫_𝛼₁^𝛼₂ ⅆ𝛼′₂[𝑈_𝛿₁𝜌₁^2𝛽−2𝑎′]'
const rightArrowExpect6 = ['Ⓐ()1/8𝜋² ∫_𝛼₁^𝛼₂ ⅆ𝛼′₂[𝑈_𝛿₁𝜌₁^2𝛽−2𝑎′]',
...
const speechExpect6 = ['1', 'end of numerator', '8', 'pi squared', 'pi ',
