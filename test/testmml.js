...
const mathSpeech = [
    ...
    "open 2 by 2 matrix,  , row 1 , eigh , b , row 2 , c , d , end matrix,  close",
    "absolute value of x , = 2 cases , case 1 , if x greater than or equal to 0 comma x , case 2 , if x less than 0 comma minus x , end cases",
    "2 equation array , equation 1 , 10 x + 3 y = 2 , equation 2 , 3 x + 13 y = 4 , end equation array",
    ...
    "absolute value of x , = 2 cases , case 1 , , x if x greater than or equal to 0 , case 2 , minus x if x less than 0 , end cases",
    ...
    "z choose k = fraction z open z minus 1 close dot dot dot open z minus k+ 1 close over k factorial , end fraction = fraction open minus 1 close to the k , open minus z close sub k over k factorial , end fraction = open minus 1 close to the k , open k minus z minus 1 close choose k .",
    "open floor 1 over n close floor = 2 by 2 matrix,  , row 1 , 1 comma , n= 1 comma , row 2 , 0 comma , n greater than 1 . , end matrix,",
    ...
    "2 by 2 parenthesized matrix , row 1 , 1 , 0 , row 2 , 0 , 1 , end parenthesized matrix",
]
