...
const speechExpect = ['start of numerator , eigh', 'end of numerator', 'start of denominator , b',
    'end of denominator', '+', 'fraction', 'start of numerator , c', 'end of numerator',
    'start of denominator , d', 'end of denominator', '=', '0', 'end of math',]
...
const rats = [    // Right Arrow Tests
    {                                       // case 0
        ...
        speechExpect: ['start of numerator , 1', 'end of numerator',
            'start of denominator , 2', 'pi', 'end of denominator',
            'integral with limits', 'integral', 'end of base',
            'start of lower limit , 0', 'end of lower limit',
            'start of upper limit , 2', 'pi', 'end of upper limit',
            'int- agrand , fraction', 'start of numerator , differential d',
            'theta', 'end of numerator', 'start of denominator , eigh', '+',
            'b', 'sine', 's', 'i', 'n', 'function apply', 'theta', 'end of function',
            'end of denominator', 'end of int- agrand', '=', 'fraction',
            'start of numerator , 1', 'end of numerator',
            'start of denominator , square root', 'start of rad- ecand , eigh squared',
            'start of base , eigh', 'end of base', 'start of superscript , 2',
            'end of superscript', 'minus', 'b squared', 'start of base , b',
            'end of base', 'start of superscript , 2', 'end of superscript',
            'end of rad- ecand', 'end of denominator', 'end of math']
    },
    {                                       // case 1
        uMath: '𝑥=(−𝑏±√(𝑏²−4𝑎𝑐))/2𝑎',
        ...
        speechExpect: ['=', 'fraction', 'start of numerator , minus', 'b', 'plus or minus',
            'square root', 'start of rad- ecand , b squared', 'start of base , b', 'end of base', 'start of superscript , 2',
            'end of superscript', 'minus', '4', 'eigh', 'c', 'end of rad- ecand',
            'end of numerator', 'start of denominator , 2', 'eigh', 'end of denominator', 'end of math',]
    },
    {                                       // case 2
        uMath: '𝑍(𝜔)≠𝑍(𝜔+1)',
    ...
    {                                       // case 3
        ...
        speechExpect: ['s', 'i', 'n', 'end of base', 'start of superscript , 2',
            'end of superscript', 'function apply', 'theta', 'end of function',
            '+', 'cosine squared', 'c', 'o', 's', 'end of base',
            'start of superscript , 2', 'end of superscript', 'function apply',
    ...
    {                                       // case 4
        ...
        speechExpect: ['integral', 'end of base', 'start of lower limit , minus',
            'infinity', 'end of lower limit', 'start of upper limit , infinity',
            'end of upper limit', 'int- agrand , superscript', 'start of base , e',
    ...
    {                                       // case 5
        ...
        speechExpect: ['start of numerator , 1', 'end of numerator', 'start of denominator , 8',
            'pi squared', 'start of base , pi', 'end of base', 'start of superscript , 2',
            'end of superscript', 'end of denominator',
            'integral with limits', 'integral', 'end of base', 'alpha sub 1 ',
            'start of base , alpha', 'end of base', 'start of subscript , 1', 'end of subscript',
            'end of lower limit', 'start of upper limit , alpha sub 2 ', 'start of base , alpha',
            'end of base', 'start of subscript , 2', 'end of subscript',
            'end of upper limit', '', 'differential d', 'sub soup', 'start of base , alpha',
            'end of base', 'start of subscript , 2', 'end of subscript',
            'start of superscript , prime', 'end of superscript',
            'fenced', 'open bracket', 'sub soup', 'start of base , cap U', 'end of base',
    ...
    {                                       // case 6
        ...
        speechExpect: ['open', 'fraction', 'start of upper element , n', 'end of upper element',
            ...
            'start of denominator , 2', 'factorial', 'end of denominator', 'end of math',]
    },
    {                                       // case 7
        uMath: 'ⅅ_𝑥 𝑓(𝑥)=1',
        ...
        rightArrowExpect: ['Ⓐ()ⅅ_𝑥 𝑓(𝑥)=1', 'Ⓐ(1)ⅅ_𝑥 𝑓(𝑥)=1', 'ⅅ_Ⓐ()𝑥 𝑓(𝑥)=1',
            ...
            'ⅅ_𝑥 𝑓(𝑥)=Ⓐ(1)1',],
        speechExpect: ['start of base , cap differential d', 'end of base',
            'start of subscript , x', 'end of subscript', 'f', 'fenced',
            'open', 'x', 'close', '=', '1', 'end of math']
    },
    {                                       // case 8
        uMath: '|𝜓⟩=∫▒𝑑^3 𝑟|𝐫⟩⟨𝐫│𝜓⟩',
        ...
        speechExpect: ['vertical bar', 'psi', 'close angle bracket', '=',
            'integral', 'd cubed', 'start of base , d', 'end of base',
            'start of superscript , 3', 'end of superscript', 'r', 'fenced',
            'vertical bar', 'bold r', 'close angle bracket', 'fenced',
            'open angle bracket', 'bold r', 'vertical bar', 'psi',
...
const lats = [      // Left Arrow Tests
    {                                       // case 0
        ...
        leftArrowExpect: ['1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/Ⓐ(3)√(𝑎²−𝑏²)',
            ...
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=Ⓐ() 1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃) Ⓐ()=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 Ⓐ(2) ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(Ⓐ(4) 𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 Ⓐ(3) sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡Ⓐ(1)𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡Ⓐ()𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sinⒶ()⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 Ⓐ(-2)sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 Ⓐ(-1)sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 Ⓐ()sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+Ⓐ()𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎Ⓐ()+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(Ⓐ()𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆⒶ(1)𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 ⅆⒶ()𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 Ⓐ()ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2𝜋 Ⓐ() ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2Ⓐ(1)𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^2Ⓐ()𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_0^Ⓐ()2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_Ⓐ(1)0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 ∫_Ⓐ()0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 Ⓐ(1)∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 Ⓐ()∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2𝜋 Ⓐ() ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2Ⓐ(1)𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/2Ⓐ()𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            '1/Ⓐ()2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            'Ⓐ(1)1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            'Ⓐ()1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            'Ⓐ() 1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
            // No movement at start of math
            'Ⓐ() 1/2𝜋 ∫_0^2𝜋 ⅆ𝜃/(𝑎+𝑏 sin⁡𝜃)=1/√(𝑎²−𝑏²)',
        ],
        speechExpect: ['end of denominator', 'end of rad- ecand',
            ...
            'start of numerator , 1', 'fraction', '=', 'end of int- agrand',
            'end of denominator', 'end of sine', 'end of argument',
            'theta', 'function apply', 'n', 'i', 'start of function , s',
            'b', '+', 'start of denominator , eigh', 'end of numerator',
            'theta', 'start of numerator , differential d', 'fraction',
            'end of upper limit', 'pi', 'start of upper limit , 2',
            'end of lower limit', 'start of lower limit , 0', 'end of base',
            'start of base , integral', 'integral with limits',
            'end of denominator', 'pi', 'start of denominator , 2',
            'end of numerator', 'start of numerator , 1',
            'start of math , fraction', '',
        ]
    },
...
function testHotKeys() {
    ...
    const tooltipTests = [
        ...
        ['𝑎', '1D44E,false,Name: MATHEMATICAL ITALIC SMALL A<br>Block: Mathematical Alphanumeric Symbols<br>Category: Ll,  Math Class: A<br>Braille: ⠨⠰⠁'],
    ]
    ...
    const convertUnicodeMathZonesTests = [
        ['The Einstein energy equation is ⁅E=mc^2⁆ as you see',
         'The Einstein energy equation is <math><mi>𝐸</mi><mo>=</mo><mi>𝑚</mi><msup><mi>𝑐</mi><mn>2</mn></msup></math> as you see'],
        [`Given a function ⁅f⁆ of a real variable ⁅x⁆ and an interval ⁅[a, b]⁆ of the real line, the **definite integral**\n⁅∫_a^b f(x) ⅆx⁆\ncan be interpreted informally as the signed area of the region in the ⁅xy⁆-plane that is bounded by the graph of ⁅f⁆, the ⁅x⁆-axis and the vertical lines ⁅x = a⁆ and ⁅x = b⁆.`,
         `Given a function <math><mi>𝑓</mi></math> of a real variable <math><mi>𝑥</mi></math> and an interval <math><mrow intent=\":fenced\"><mo>[</mo><mrow><mi>𝑎</mi><mo>,</mo><mi>𝑏</mi></mrow><mo>]</mo></mrow></math> of the real line, the **definite integral**
...
can be interpreted informally as the signed area of the region in the <math><mi>𝑥</mi><mi>𝑦</mi></math>-plane that is bounded by the graph of <math><mi>𝑓</mi></math>, the <math><mi>𝑥</mi></math>-axis and the vertical lines <math><mi>𝑥</mi><mo>=</mo><mi>𝑎</mi></math> and <math><mi>𝑥</mi><mo>=</mo><mi>𝑏</mi></math>.`],
    ]
