...
const mathSpeech = [
    "1 over 2 pi  integral from 0 to 2 h smash pi  of , fraction differential d theta  over eigh + b sine theta  , end fraction = fraction 1 over square root of eigh squared minus b squared ",
    ...
    "x = fraction minus b plus or minus square root of b squared minus 4 eigh c , end square root over 2 eigh ",
    ...
    "color hex e01 f32 , alpha  ",
    "back color brown eigh + b ",
    ...
    "fraction differential d squared gamma  conjugate over differential d z squared , end fraction not equal fraction differential d gamma  conjugate over differential d z ",
