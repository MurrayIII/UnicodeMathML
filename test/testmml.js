...
const mathTeX = [                           // Some cases aren't supported by TeX
    ...
    '\\sqrt[𝑛]{𝑎+𝑏}',
    '\\cos ⁡𝜃=\\frac{1}{2}𝑒^{ⅈ𝜃}+\\textrm{c.c.}',
    '(\\begin{matrix}{𝑎&𝑏}\\\\\n{𝑐&𝑑}\\end{matrix})',
    '|𝑥|=\\cases{begin{eqnarray}\\textrm{if }𝑥≥&{0,}&𝑥\\\\\n\\textrm{if }𝑥<&{0,}&{−𝑥}\\end{eqnarray}}',
    '\\begin{eqnarray}{10}&{𝑥+}&{3&{𝑦=2}}\\\\\n{3&{𝑥+}}&{13}&{𝑦=4}\\end{eqnarray}',
    '\\abs{𝑎+𝑏}',
    ...
    '\\frac{𝑑𝜓⁡(𝑥,𝑡)}{𝑑𝑡}=0',
    '𝑎^2+𝑏^2=𝑐^2',
    '𝑍(𝛾+𝑖𝜔−𝑖𝜈)=\\frac{𝑖}{\\sqrt{𝜋}}∫_{−∞}^∞\\frac{𝑒^{−(𝜔−𝜔′)^2/(Δ𝜔)^2}}{𝛾+𝑖(𝜔′−𝜈)}ⅆ𝜔′',
    '\\sin ⁡{\\frac{𝑥+𝑎}{2}}',
    '|𝑥|={\\begin{eqnarray}{​&{𝑥\\textrm{ if }𝑥≥0}}\\\\\n{−&{𝑥\\textrm{ if }𝑥<0}}\\end{eqnarray}',
    '\\frac{ⅆ}{ⅆ𝑧}⁡\\arcsin ⁡𝑧=(1−𝑧^2)^{−1/2},',
    '𝜃_1⁡(𝑧│𝜏)=𝜃_1⁡(𝑧,𝑞)=2⁢∑_{𝑛=0}^∞(−1)^𝑛⁢𝑞^(𝑛+\\frac{1}{2})^2⁢\\sin ⁡((2⁢𝑛+1)⁢𝑧),',
    '\\choose{𝑧}{𝑘}=\\frac{𝑧⁢(𝑧−1)⁢⋯⁢(𝑧−𝑘+1)}{𝑘!}=\\frac{(−1)^𝑘⁢(−𝑧)_𝑘}{𝑘!}=(−1)^𝑘⁢\\choose{𝑘−𝑧−1}{𝑘}.',
    '\\frac{ⅆ𝛾′}{ⅆ𝑧}',
    '\\frac{ⅆ^2𝛾^∗}{ⅆ𝑧^2}≠\\frac{ⅆ𝛾^∗}{ⅆ𝑧}',
    '\\frac{𝜕𝑓⁡(𝑥,𝑥′)}{𝜕𝑥′}=0',
    '\\frac{𝜕^2𝑓⁡(𝑥)}{𝜕𝑥^2}',
    '\\choose{𝑧}{𝑘}=\\frac{𝑧⁢(𝑧−1)⁢⋯⁢(𝑧−𝑘+1)}{𝑘!}=\\frac{(−1)^𝑘⁢(−𝑧)_𝑘}{𝑘!}=(−1)^𝑘⁢\\choose{𝑘−𝑧−1}{𝑘}.',
    '⌊\\frac{1}{𝑛}⌋={\\begin{matrix}{1,}&{𝑛=1,}\\\\\n{0,}&{𝑛>1.}\\end{matrix}',
