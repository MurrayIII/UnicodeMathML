...
const mathSpeech = [
    ...
    "i h bar partial-derivative of psi  open x comma t close with respect to t = open bracket minus fraction h bar squared over 2 m , end fraction second partial-derivative of with respect to x + cap V open x comma t close close bracket psi  open x comma t close",
    ...
    "partial-derivative of f open x comma x prime close with respect to x prime = 0",
