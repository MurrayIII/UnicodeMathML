...
const mathSpeech = [
    "1 over 2 pi  integral from 0 to 2 h smash pi  of , fraction differential d theta  over eigh + b sine theta  , end fraction = fraction 1 over square root of eigh squared minus b squared , end square root , end fraction ",
    ...
    "vertical bar x vertical bar = cases if x greater than or equal to 0 comma x , next case,  if x less than 0 comma minus x , end cases ",
    "equation array 10 x + 3 y = 2 , next equation,  3 x + 13 y = 4 , end equation array ",
    ...
    "differential d over differential d z arcsine z= open paren 1 minus z squared close paren to the open paren minus 1 over 2 close paren comma ",
    ...
    "z choose k = fraction z open paren z minus 1 close paren dot dot dot open paren z minus k+ 1 close paren over k factorial , end fraction = fraction open paren minus 1 close paren to the k open paren minus z close paren sub k over k factorial , end fraction = open paren minus 1 close paren to the k open paren k minus z minus 1 close paren choose k . ",
    "open floor 1 over n close floor = open brace matrix,  1 comma and n= 1 comma , next row, 0 comma and n greater than 1 . , end matrix,  close ",
